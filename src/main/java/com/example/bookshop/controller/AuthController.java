...
import com.example.bookshop.dto.JwtResponse;
import com.example.bookshop.dto.MessageResponse;
import com.example.bookshop.repository.RoleRepository;
import com.example.bookshop.repository.UserRepository;
import com.example.bookshop.commom.JwtUtils;
import com.example.bookshop.service.impl.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		user.setCreatedDate(GetDateNow.getDate());
		user.setUpdatedDate("undefined");
